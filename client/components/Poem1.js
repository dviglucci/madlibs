      ...
      <div>
        <div className="final-poem">
          ...
          <div className="stanza">
            <div>
              Two {this.props.poem1.noun}s diverged in a {this.props.poem1.adj}{" "}
              wood,
            </div>
            <div>And sorry I could not {this.props.poem1.verb} both</div>
            <div>And be one traveler, {this.props.poem1.adj2} I stood</div>
            <div>
              And {this.props.poem1.verbPast} down one as far as I could
            </div>
            <div>
              To where it {this.props.poem1.verb2Past} in the undergrowth;
            </div>
          </div>

          <div className="stanza">
            <div>
              Then {this.props.poem1.verb3Past} the other, as just as{" "}
              {this.props.poem1.adj3},
            </div>
            ...
            <div>
              Had {this.props.poem1.verb4Past} them really about the same,
            </div>
          </div>
          ...
          <div className="stanza">
            ...
            <div>
              Yet knowing how {this.props.poem1.noun5} leads on to{" "}
              {this.props.poem1.noun5},
            </div>
            <div>
              I {this.props.poem1.verb5Past} if I should ever come back.
            </div>
          </div>
          ...
          <div className="stanza">
            ...
            <div>
              Somewhere {this.props.poem1.pluralNoun} and{" "}
              {this.props.poem1.pluralNoun} hence:
            </div>
